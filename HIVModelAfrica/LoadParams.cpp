...
void loadCD4StartArray(){
    ...
    char fileName[] = "/Users/mc1405/Dropbox/HIVModelZimbabwe/HIVModelZimbabwe/LoadParam.txt";
...
void loadCD4ProgArray()
{
    ...
    // 1. make a param reader object.
    CParamReader myReader;
    char fileName[] = "/Users/Mikaela/Dropbox/HIVModelZimbabwe/HIVModelZimbabwe/LoadParam.txt";
    if(! myReader.setNewFileName(fileName))
    {
        cout << "File " << fileName << " doesn't exist." << endl;
        exit(0);
...
void loadNCDArray(){
    ...
    ifstream myfile("/Users/Mikaela/Dropbox/HIVModelZimbabwe/HIVModelZimbabwe/NCDArray.csv");
...
void loadCancerArray(){
    ...
    ifstream myfile("/Users/Mikaela/Dropbox/HIVModelZimbabwe/HIVModelZimbabwe/CancerArray.csv");
...
void loadBirthArray(){
    ...
    ifstream myfile("/Users/Mikaela/Dropbox/HIVModelZimbabwe/HIVModelZimbabwe/fertility.csv");
...
void loadDeathArray_Women(){
    ...
    ifstream myfile1("/Users/Mikaela/Dropbox/HIVModelZimbabwe/HIVModelZimbabwe/mortality_array_women.csv");
...
void loadDeathArray_Men()
{
    ...
    ifstream myfile2("/Users/Mikaela/Dropbox/HIVModelZimbabwe/HIVModelZimbabwe/mortality_array_men.csv");
...
void loadHIVArray_Women()
{
    ...
    ifstream myfile3("/Users/Mikaela/Dropbox/HIVModelZimbabwe/HIVModelZimbabwe/HIV_incidence_women.csv");
...
void loadHIVArray_Men(){
    ...
    ifstream myfile4("/Users/Mikaela/Dropbox/HIVModelZimbabwe/HIVModelZimbabwe/HIV_incidence_men.csv");
